# DadaPlayTimePatch 1.0

> Patch integrata per /playtime reset.
...
**DadaPlayTimePatch 1.0** is a custom Minecraft plugin for Paper/Spigot servers.

Patch integrata per /playtime reset.

| Field | Value |
| --- | --- |
| Plugin | `DadaPlayTimePatch` |
| Version | `1.0` |
| Category | Community, Web and Display |
| Main class | `it.dadasmp.playtimepatch.DadaPlayTimePatchPlugin` |
| Dependencies | `depend: [DadaPlayTime]` |
...
`release/DadaPlayTimePatch-1.0.jar`
